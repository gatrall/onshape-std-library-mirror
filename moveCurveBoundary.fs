...
export import(path : "onshape/std/movecurveboundarytype.gen.fs", version : "3044.0");
export import(path : "onshape/std/curveextensionendcondition.gen.fs", version : "3044.0");
export import(path : "onshape/std/curveextensionshape.gen.fs", version : "3044.0");
