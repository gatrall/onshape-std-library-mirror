...
export import(path : "onshape/std/bodydraftconcaverepairtype.gen.fs", version : "3044.0");
export import(path : "onshape/std/bodydraftcornertype.gen.fs", version : "3044.0");
export import(path : "onshape/std/bodydraftmatchfacetype.gen.fs", version : "3044.0");
export import(path : "onshape/std/bodydraftselectiontype.gen.fs", version : "3044.0");
/* opBoolean uses enumerations from TopologyMatchType */
export import(path : "onshape/std/topologymatchtype.gen.fs", version : "3044.0");
/* opCreateCurvesOnFace uses enumerations from FaceCurveCreationType */
export import(path : "onshape/std/facecurvecreationtype.gen.fs", version : "3044.0");
/* opChamfer uses enumerations from ChamferType */
export import(path : "onshape/std/chamfertype.gen.fs", version : "3044.0");
/* opDraft uses enumerations from DraftType */
export import(path : "onshape/std/drafttype.gen.fs", version : "3044.0");
/* opExtendSheet uses enumerations from ExtendSheetBoundingType */
export import(path : "onshape/std/extendsheetboundingtype.gen.fs", version : "3044.0");
/* opExtractSurface uses enumerations from ExtractSurfaceRedundancyType */
export import(path : "onshape/std/extractsurfaceredundancytype.gen.fs", version : "3044.0");
/* opExtrude uses enumerations from BoundingType */
export import(path : "onshape/std/boundingtype.gen.fs", version : "3044.0");
/* opFillet uses enumerations from FilletCrossSection */
export import(path : "onshape/std/filletcrosssection.gen.fs", version : "3044.0");
/* opFillSurface uses enumerations from GeometricContinuity */
export import(path : "onshape/std/geometriccontinuity.gen.fs", version : "3044.0");
/* opHole uses objects from holeUtils, as well as enums `export import`ed in that file */
export import(path : "onshape/std/holeUtils.fs", version : "3044.0");
/* opRuledSurface uses CoordSystem */
export import(path : "onshape/std/coordSystem.fs", version : "3044.0");
/* opSplitPart uses enumerations from SplitOperationKeepType */
export import(path : "onshape/std/splitoperationkeeptype.gen.fs", version : "3044.0");
/* opWrap uses enumerations from WrapType */
export import(path : "onshape/std/wraptype.gen.fs", version : "3044.0");
