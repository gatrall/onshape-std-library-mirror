...
import(path : "onshape/std/compositeCurve.fs", version : "3044.0");
...
import(path : "onshape/std/loft.fs", version : "3044.0");
import(path : "onshape/std/moveCurveBoundary.fs", version : "3044.0");
