...
import(path : "onshape/std/imagemappingtype.gen.fs", version : "3044.0");
import(path : "onshape/std/math.fs", version : "3044.0");
import(path : "onshape/std/persistentCoordSystem.fs", version : "3044.0");
...
import(path : "onshape/std/transformUV.fs", version : "3044.0");
